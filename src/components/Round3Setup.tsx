  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        ...
        >
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-brand-soft border border-brand-light/30 text-[10px] uppercase tracking-[0.18em] font-semibold text-brand-light">
            Round 3 · Live
          </span>
        </motion.div>
        ...
        >
          ...
          <span>
            You&apos;ll have 1 minute. Speak naturally — {scene.personaName} hears
            you in real time.
          </span>
        </motion.div>
      </div>
